...
import { ShopContect } from '../context/ShopContect'; // Perbaikan nama import
...
const PlaceOrder = () => {
  ...
  const { backendUrl, token, cartItem, setCartItem, getCartAmount, delivery_fee, products } = useContext(ShopContect);
